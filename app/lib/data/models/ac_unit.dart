...
/// Status unit AC (disimpan sebagai string snake_case di Firestore).
enum AcUnitStatus {
...
/// Unit AC milik member (koleksi `member_ac_units`). `barcodeValue` kosong
/// sebelum digenerate Cloud Function. Tanggal pasang/servis diisi pada fase
/// servis. `id` kosong saat create.
class AcUnit {
  const AcUnit({
    this.id = '',
